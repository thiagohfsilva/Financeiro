...
class Transaction:
    def __init__(self, p_id: int, p_value : int, p_periodic: bool,
...
class Month:
    ...
    def get_balance(self):
        ...
        return sum(transaction.value for transaction in self.transaction_list if transaction.done)
    
    def display_transactions_table(self):
        '''
        Exibe as transações do mês em forma de tabela.
        '''
        headers = ["ID", "Valor", "Periódica", "Nota", "Tipo", "Concluída", "Dia de Vencimento", "Responsável"]
        table_data = []
...
class FinancialYear:
    ...
    def load_data_from_json(self, json_file_path):
        ...
        try:
            with open(json_file_path, 'r') as file:
                ...
                if 'months' in data:
                    ...
                    for month_data in data['months']:
                        ...
                        transaction_list = []
                        for transaction_data in month_data.get('transaction_list', []):
                            transaction_list +=[Transaction(transaction_data["id"],
                        ...
                        month = Month(p_mes=month_data['mes'],
            ...
            raise ValueError(f"Erro ao decodificar o JSON no arquivo {json_file_path}.")
    ...
    def save_data_to_json(self):
        ...
        try:
            with open(self.json_file_path, 'w') as file:
                ...
                print(f"Dados salvos com sucesso no arquivo JSON: {self.json_file_path}")
        except IOError:
            print(f"Erro ao salvar os dados no arquivo JSON: {self.json_file_path}")
